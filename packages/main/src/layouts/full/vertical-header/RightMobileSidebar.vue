...
<template>
    <div class="pt-6">
        <h5 class="text-lg mb-4 px-5">Navigation</h5>
        <v-list v-model:opened="open" class="right-sidebar">
            ...
            <v-list-item>
                ...
                <h5 class="text-sm ml-2">Chats</h5>
            </v-list-item>
            <v-list-item>
                <template v-slot:prepend>
                    <CalendarIcon width="21" stroke-width="1.5" />
                </template>
                <h5 class="text-sm ml-2">Calendar</h5>
            </v-list-item>
            <v-list-item>
                <template v-slot:prepend>
                    <MailIcon width="21" stroke-width="1.5" />
                </template>
                <h5 class="text-sm ml-2">Mail</h5>
            </v-list-item>
        </v-list>
        <div class="px-5">
            <h5 class="text-lg my-4">Quick Links</h5>
            <QuickLinks />
        </div>
    </div>
</template>
