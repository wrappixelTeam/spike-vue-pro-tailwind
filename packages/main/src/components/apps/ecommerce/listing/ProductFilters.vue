    ...
    <v-sheet class="pa-4 pt-1">
        <v-expansion-panels v-model="panel" multiple>
            <v-expansion-panel elevation="0">
                <v-expansion-panel-title class="font-medium custom-accordion"> Gender </v-expansion-panel-title>
            ...
            <v-divider />
            <v-expansion-panel elevation="0">
                <v-expansion-panel-title class="font-medium custom-accordion"> Categories </v-expansion-panel-title>
                <v-expansion-panel-text class="acco-body">
                    <v-row no-gutters>
                        <v-col cols="12">
            ...
            <v-divider />
            <v-expansion-panel elevation="0">
                <v-expansion-panel-title class="font-medium custom-accordion"> Colors </v-expansion-panel-title>
                <v-expansion-panel-text class="acco-body">
            ...
            <v-divider />
            <v-expansion-panel elevation="0">
                <v-expansion-panel-title class="font-medium custom-accordion"> Price </v-expansion-panel-title>
                <v-expansion-panel-text class="acco-body">
            ...
            <v-divider />
            <v-expansion-panel elevation="0">
                <v-expansion-panel-title class="font-medium custom-accordion"> Rating </v-expansion-panel-title>
                <v-expansion-panel-text class="acco-body">
