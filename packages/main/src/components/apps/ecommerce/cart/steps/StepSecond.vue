    ...
    <v-row>
        <v-col cols="12">
            <div class="flex items-center my-5">
                ...
                <v-btn size="small" color="primary" rounded="pill" class="ml-auto" @click="dialog = true"><PlusIcon size="16" /> Add Address</v-btn>
            </div>
            <v-row>
        ...
        <v-col lg="4" cols="12" md="12">
            <div v-for="address in store.addresses" class="mt-7">
                <template v-if="address.isDefault">
                    <h5 class="text-lg mb-4">Shipping Address</h5>
                    <AddressCard
                        :name="address.name"
                        :destination="address.destination"
                        :isDefault="address.isDefault"
