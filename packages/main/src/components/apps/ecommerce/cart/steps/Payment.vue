...
<template>
    <v-row class="mt-5">
        <v-col cols="12" lg="9">
            <h5 class="text-lg mb-4">Delivery Options</h5>
                        ...
                        <div class="py-5 px-4 border rounded-md">
                            <v-radio value="free" color="primary" class="label-op-1">
                                <template v-slot:label>
                                    <div>
                                        <h6 class="text-base mb-1">Standard Delivery (Free)</h6>
                                        <span class="d-block text-sm">Delivery on Monday 8 Jun</span>
                                    </div>
                                </template>
                            </v-radio>
                        </div>
                    ...
                    <v-col cols="12 " sm="6">
                        <div class="py-5 px-4 border rounded-md">
                            <v-radio value="paid" color="primary" class="label-op-1">
                                <template v-slot:label>
                                    <div>
                                        <h6 class="text-base mb-1">Fast Delivery ($5.00)</h6>
                                        <span class="d-block text-sm">Delivery on Friday 5 Jun</span>
                                    </div>
                                </template>
                            </v-radio>
                        </div>
            ...
            <h5 class="text-lg mb-4">Payment Options</h5>
            <v-row>
                <v-col cols="12" lg="7">
                            ...
                            <v-radio value="paypal" color="primary" class="label-op-1">
                                <template v-slot:label>
                                    <div class="flex items-center w-100">
                                        <div>
                                            <h6 class="text-base mb-1">Pay with PayPal</h6>
                                            <span class="d-block text-sm text-wrap"
                        ...
                        <div class="py-5 px-4 border rounded-md mb-6">
                            <v-radio value="credit" color="primary" class="label-op-1">
                                <template v-slot:label>
                                    <div class="flex items-center w-100">
                                        <div>
                                            <h6 class="text-base mb-1">Credit/Debit Card</h6>
                                            <span class="d-block text-sm text-wrap"
                        ...
                        <v-card elevation="0" class="mb-6 " variant="outlined" v-if="payment == 'credit'">
                            <v-card-item class="py-3">
                                <div class="flex items-center justify-between">
                                    <v-card-title class="text-sm">Add New Card</v-card-title>
                                    ...
                                    <v-col md="6" cols="12">
                                        <v-card elevation="0" class="object-card overflow-hidden">
                                            <v-card-text class="top-object">
                                                ...
                                                <h6 class="text-white text-medium-emphasis text-lg">**** **** **** 2599</h6>
                                                <div class="flex items-center justify-between mt-3">
                                                    <div>
                                                        <span class="text-medium-emphasis text-white text-xs opacity-50"
                                                            >Expire Date</span
                                                        >
                                                        <span
                                                            class="text-medium-emphasis text-white text-xs opacity-50 mt-1 d-block"
                                                            >05/24</span
                                                        >
                                                    </div>
                                                    <div>
                                                        <span class="text-medium-emphasis text-white text-xs opacity-50">CVV</span>
                                                        <span
                                                            class="text-medium-emphasis text-white text-xs opacity-50 mt-1 d-block"
                                                            >085</span
                                                        >
                                    ...
                                    <v-col md="6" cols="12">
                                        <v-card elevation="0" class="object-card object-secondary overflow-hidden">
                                            <v-card-text class="top-object">
                                                ...
                                                <h6 class="text-white text-medium-emphasis text-lg mt-4">**** **** **** 2599</h6>
                                                <div class="flex items-center justify-between mt-3">
                                                    <div>
                                                        <span class="text-medium-emphasis text-white text-xs opacity-50"
                                                            >Expire Date</span
                        ...
                        <div class="py-5 px-4 border rounded-md mb-6">
                            <v-radio value="cash" color="primary" class="label-op-1">
                                <template v-slot:label>
                                    <div class="flex items-center w-100">
                                        <div>
                                            <h6 class="text-base mb-1">Cash on Delivery</h6>
                                            <span class="d-block text-sm text-wrap"
                ...
                <v-col cols="12" lg="5" class="flex items-center">
        ...
        <v-col lg="3" cols="12">
            <h5 class="text-lg">Cart Item</h5>
            <div class="flex items-center gap-2 my-3" v-for="item in getCart" :key="item.name">
                <img alt="product" class="rounded-md custom-img-box" :src="item.image" />
                <div class="ma-2">
                    <h6 class="text-base">{{ item.name }}</h6>
                    <span class="text-sm">${{ item.salePrice * item.qty }}</span>
                </div>
            </div>
            <OrderSummaryVue />
