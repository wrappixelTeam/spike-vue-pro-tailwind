    ...
    <v-card variant="outlined">
        <v-card-text>
            ...
            <div class="mt-4 mb-6 text-body1">
                <p class="text-xs lh-md">{{ building }}, {{ city }}, {{ state }}</p>
                <h6 class="text-base mt-4 flex items-center"><DeviceMobileIcon size="20" class="mr-2" /> {{ phone }}</h6>
            </div>
            <div class="d-sm-flex items-center gap-2" v-if="showBtn">
                <v-btn variant="outlined" rounded="pill" color="primary">Deliver to This Address</v-btn>
