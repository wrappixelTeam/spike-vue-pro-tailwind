        ...
        <v-card-text>
            <v-tabs v-model="tab" color="primary" class="customTab">
                <v-tab value="tab-1" rounded="md" class="mb-3 mx-2 text-left" height="70">
                    ...
                    <div>
                        <div>Item Cart</div>
                        <span class="text-xs text-lightText text-medium-emphasis font-medium d-block">Product Summary</span>
                    </div>
                </v-tab>
                ...
                <v-tab value="tab-2" rounded="md" class="mb-3 mx-2 text-left" height="70" :disabled="store.cart.length < 1">
                    ...
                    <div>
                        <div>Billing</div>
                        <span class="text-xs text-lightText text-medium-emphasis font-medium d-block">
                            Billing Information
                        </span>
                    </div>
                </v-tab>
