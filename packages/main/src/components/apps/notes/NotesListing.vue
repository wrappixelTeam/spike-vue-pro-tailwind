...
<template>
    ...
    <!-- ---------------------------------------------------- -->
    <div class="pa-6">
        <h4 class="text-base mb-4 font-semibold">All Notes</h4>
        ...
        >
            <h6 :class="'text-base text-truncate text-' + note.color">{{ note.title }}</h6>
            <div class="flex mt-3 items-center">
                <small class="text-xs opacity-25">{{ new Date(note.datef).toLocaleDateString() }}</small>
