    ...
    <v-card elevation="10" class="bg-surface">
        <v-card-item>
            <div class="flex gap-3 items-center">
                ...
                <div class="d-block d-sm-flex items-center gap-3">
                    <h6 class="text-base">{{ post?.profile.name }}</h6>
            ...
            <div class="my-4 mt-5 flex items-center gap-3">
                <v-tooltip text="Like">
                ...
                <span class="text-sm font-semibold">{{ post?.data && post?.data.likes && post?.data.likes.value }}</span>
                ...
                <span class="text-sm font-semibold">{{ post?.data.comments ? post?.data.comments.length : 0 }}</span>
                <v-menu>
                    <template v-slot:activator="{ props }">
        ...
        <div v-if="showCommentBox">
            <v-divider />
            <div class="d-block d-sm-flex gap-3 items-center mb-4 px-4 pt-4">
