...
<template>
    <v-card variant="flat" class="mb-3 pa-5 border bg-surface">
        <div class="flex gap-3 items-center">
            ...
            <div class="d-block d-sm-flex items-center gap-3">
                <h6 class="text-base">{{ comments?.profile.name }}</h6>
        ...
        <div v-for="reply in comments?.data.replies">
            <v-card variant="flat" class="mb-3 pa-5 border">
                <div class="flex gap-3 items-center">
                    ...
                    <div class="d-block d-sm-flex items-center gap-3">
                        <h6 class="text-base">{{ reply.profile.name }}</h6>
                        <span class="text-xs opacity-50">
                            <CircleIcon size="8" fill="inherit" class="opacity-50 mr-1" />
                            {{ reply.profile.time }}
                        </span>
    ...
    <div class="d-block d-sm-flex gap-3 items-center mb-5 ml-10" v-if="showReplyBox">
