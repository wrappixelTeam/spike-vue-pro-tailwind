...
<template>
    <div v-if="chatDetail" class="customHeight">
        <div>
            <div class="flex items-center gap-3 pa-4  justify-between">
                <!---Topbar Row-->
                <div class="flex gap-2 items-center">
                    ...
                    <!---Name & Last seen-->
                    <div>
                        <h5 class="text-lg mb-n1">{{ chatDetail.name }}</h5>
                ...
                <div class="flex">
                    <div class="w-100" style="height: calc(100vh - 360px);">
                        <div v-for="chat in chatDetail.chatHistory" :key="chat.id" class="pa-5">
                            <div v-if="chatDetail.id === chat.senderId" class="justify-end flex text-end mb-1">
                                <div>
                                    <small class="text-medium-emphasis text-xs" v-if="chat.createdAt">
                                        {{
                            ...
                            <div v-else class="flex align-items-start gap-3 mb-1">
                                <!---User Avatar-->
                                <v-avatar>
