        ...
        <v-col cols="12">
            <v-card elevation="10"  rounded="md">
                <v-img :src="post.coverImg" height="440" cover class="rounded-t-md align-end text-right">
                    <v-card-item
                        ><v-chip class="bg-surface text-xs font-medium" size="small" v-text="post.view"></v-chip
                    ></v-card-item>
                </v-img>
                ...
                <v-card-item class="pt-4 blog-detail">
                    <v-chip class="text-xs font-medium bg-grey100" size="small" v-text="post.category"></v-chip>
                    <h1 class="text-h1 font-medium my-6">{{ post.title }}</h1>
                ...
                <v-divider></v-divider>
                <div class="pa-6">
                    <h2 class="text-3xl">Title of the paragraph</h2>
                    <p class="my-4 text-sm text-10">
                    ...
                    <p class="text-sm font-bold text-10">This is strong text.</p>
                    <p class="text-sm font-italic text-10">This is italic text.</p>
                    <v-divider class="my-8"></v-divider>
                    <h3 class="text-2xl">Unorder list.</h3>
                    <ul class="ml-10 mt-3">
                        <li class="text-sm">Gigure out what it is or</li>
                        <li class="text-sm">The links it currently</li>
                        <li class="text-sm">It allows you to start your bid</li>
                        <li class="text-sm">Gigure out what it is or</li>
                        <li class="text-sm">The links it currently</li>
                        <li class="text-sm">It allows you to start your bid</li>
                    </ul>
                    <v-divider class="my-8"></v-divider>
                    <h3 class="text-2xl">Order list.</h3>
                    <ol class="ml-10 mt-3">
                        <li class="text-sm">Gigure out what it is or</li>
                        <li class="text-sm">The links it currently</li>
                        <li class="text-sm">It allows you to start your bid</li>
                    ...
                    <v-divider class="my-8"></v-divider>
                    <h3 class="text-2xl">Quotes</h3>
                    <div class="flex mt-8 font-bold ml-4">
