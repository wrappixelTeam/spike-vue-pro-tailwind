...
<template>
    ...
    <table class="mt-5 w-full">
        <thead>
            <tr>
                <th class="text-sm text-textSecondary text-left font-semibold">Id</th>
                <th class="text-sm text-textSecondary text-left font-semibold">UserInfo</th>
                <th class="text-sm text-textSecondary text-left font-semibold">Phone</th>
                <th class="text-sm text-textSecondary text-left font-semibold">Joining Date</th>
                <th class="text-sm text-textSecondary text-left font-semibold">Role</th>
                <th class="text-sm text-textSecondary text-left font-semibold">Actions</th>
            </tr>
        </thead>
        <tbody>
            <tr v-for="item in filteredList" :key="item.id">
                ...
                <td>
                    <div class="flex items-center">
                        <img :src="item.avatar"  class="rounded-full h-11 w-11">
                        <div class="ml-5">
                            <h4 class="text-sm font-semibold text-no-wrap">{{ item.userinfo }}</h4>
                            <span class="text-sm d-block mt-1 textSecondary">{{ item.usermail }}</span>
                        </div>
                    </div>
                </td>
                <td class="text-sm">{{ item.phone }}</td>
                <td class="text-sm">{{ item.jdate }}</td>
                <td>
