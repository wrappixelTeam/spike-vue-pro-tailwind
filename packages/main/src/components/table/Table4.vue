...
<template>
    <v-card elevation="0" class="mt-6 border">
        ...
        <v-table class="month-table">
            <thead>
                <tr>
                    <th class="text-sm font-semibold">Invoice</th>
            ...
            <tbody>
                <tr v-for="item in basicTableData4" :key="item.name" class="month-item">
                    <td>
                        <h6 class="text-sm font-semibold text-no-wrap">{{ item.invoice}}</h6>
                    </td>
                    <td>
                        <v-chip rounded="pill" class="font-medium py-4 pl-1 pr-2" :color="item.statuscolor" size="small">
                    ...
                    <td>
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <div class="text-sm text-no-wrap font-medium text-grey100">{{ item.handle }}</div>
                            </div>
                        </div>
                    </td>
                    <td>
                        <div class="flex items-center">
                            ...
                            <div >
                                <span class="text-sm  text-medium-emphasis ml-5">{{item.progress}}%</span>
                            </div>
                        </div>    
                    </td>
                    <td>
