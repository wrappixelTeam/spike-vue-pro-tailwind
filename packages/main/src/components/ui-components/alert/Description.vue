<template>
    <v-alert type="error" variant="tonal" class="mb-4">
        <h5 class="text-base text-capitalize">error</h5>
        <div>This is an error alert — check it out!</div>
    </v-alert>
    <v-alert type="warning" variant="tonal" class="mb-4">
        <h5 class="text-base text-capitalize">warning</h5>
        <div>This is an warning alert — check it out!</div>
    </v-alert>
    <v-alert type="info" variant="tonal" class="mb-4">
        <h5 class="text-base text-capitalize">info</h5>
        <div>This is an info alert — check it out!</div>
    </v-alert>
    <v-alert type="success" variant="tonal" class="mb-4">
        <h5 class="text-base text-capitalize">success</h5>
