...
<template>
    <div class="flex flex-wrap items-center gap-3">
        ...
        <v-chip color="primary" class="text-xs">
        ...
        <v-chip color="secondary" class="text-xs">
        ...
        <v-chip color="success" class="text-xs">
            <v-avatar start size="25">
        ...
        <v-chip color="warning" class="text-xs">
            <MoodSmileIcon class="mr-2" start size="20" /> Default Filled 
        </v-chip>
        <v-chip color="warning" class="text-xs">
            <MoodSmileIcon class="mr-2" start size="20" /> Default Deletable 
        ...
        <v-chip color="error" class="text-xs">
            <v-avatar start size="25">
