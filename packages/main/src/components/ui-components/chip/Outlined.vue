...
<template>
    <div class="flex flex-wrap items-center gap-3">
        <v-chip variant="outlined" class="text-xs">
        ...
        <v-chip variant="outlined" color="primary" class="text-xs">
        ...
        <v-chip variant="outlined" color="secondary" class="text-xs">
        ...
        <v-chip variant="outlined" color="success" class="text-xs">
            <v-avatar start size="25">
        ...
        <v-chip variant="outlined" color="warning" class="text-xs">
            <MoodSmileIcon class="mr-2" start size="20" /> Default Filled 
        </v-chip>
        <v-chip variant="outlined" color="warning" class="text-xs">
            <MoodSmileIcon class="mr-2" start size="20" /> Default Deletable 
        ...
        <v-chip variant="outlined" color="error" class="text-xs">
            <v-avatar start size="25">
