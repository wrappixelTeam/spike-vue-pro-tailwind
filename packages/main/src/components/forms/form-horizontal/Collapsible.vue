    ...
    <v-expansion-panels>
        ...
        <v-expansion-panel elevation="10" >
            ...
            <v-expansion-panel-text class="mt-4">
                <v-row>
                    <v-col cols="12" md="6">
                        <v-row class="items-center mb-3">
                            <v-col cols="12" sm="3" class="pb-sm-3 pb-0 text-right">
                                <v-label class="font-medium">Full Name</v-label>
                            </v-col>
                            <v-col cols="12" sm="9">
                        ...
                        <v-row class="items-center mb-3">
                            <v-col cols="12" sm="3" class="pb-sm-3 pb-0 text-right">
                                <v-label class="font-medium">Address</v-label>
                            </v-col>
                            <v-col cols="12" sm="9">
                                <v-textarea
                                    auto-grow
                        ...
                        <v-row class="items-center mb-3">
                            <v-col cols="12" sm="3" class="pb-sm-3 pb-0 text-right">
                                <v-label class="font-medium">City</v-label>
                            </v-col>
                            <v-col cols="12" sm="9">
                        ...
                        <v-row class="align-start">
                            <v-col cols="12" sm="3" class="pb-sm-3 pb-0 text-right">
                                <v-label class="mt-sm-2 mt-0 font-medium">Address Type</v-label>
                            </v-col>
                            <v-col cols="12" sm="9">
                    ...
                    <v-col cols="12" md="6">
                        <v-row class="items-center mb-3">
                            <v-col cols="12" sm="3" class="pb-sm-3 pb-0 text-right">
                                <v-label class="font-medium">Phone No</v-label>
                            </v-col>
                            <v-col cols="12" sm="9">
                        ...
                        <v-row class="items-center mb-3">
                            <v-col cols="12" sm="3" class="pb-sm-3 pb-0 text-right">
                                <v-label class="font-medium">Pincode</v-label>
                            </v-col>
                            <v-col cols="12" sm="9">
                        ...
                        <v-row class="items-center mb-3">
                            <v-col cols="12" sm="3" class="pb-sm-3 pb-0 text-right">
                                <v-label class="font-medium">Landmark</v-label>
                            </v-col>
                            <v-col cols="12" sm="9">
