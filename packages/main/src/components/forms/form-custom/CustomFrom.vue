...
<template>
    <v-row>
        <v-col cols="12" sm="4">
            ...
            <v-label class="mb-2 font-medium">Select Dropdown</v-label>
            <v-select
                :items="items"
                item-title="items"
                item-value="abbr"
        ...
        <v-col cols="12" sm="4">
            <v-label class="mb-2 font-medium">Company Name</v-label>
            <v-text-field variant="outlined" placeholder="Enter Text" color="primary"></v-text-field>
            <v-label class="mb-2 font-medium">Time</v-label>
            <v-text-field variant="outlined" placeholder="hh:mm"  type="time" color="primary"></v-text-field>
        </v-col>
        <v-col cols="12" sm="4">
            <v-label class="mb-2 font-medium">Industry Type</v-label>
            <v-text-field variant="outlined" placeholder="Disabled Filled" color="primary"></v-text-field>
            <v-label class="mb-2 font-medium">Date</v-label>
            <v-text-field variant="outlined" type="date" color="primary"></v-text-field>
        </v-col>
        
        <v-col cols="12">
            <v-label class="mb-2 font-medium">Lorem ipsum dolor sit amet</v-label>
            ...
            <v-row>
                <v-col cols="12" md="4">
                    <v-label class="mb-2 font-medium">Slider</v-label>
                    ...
                    <v-label class="mb-2 font-medium">Volume</v-label>
            ...
            <v-label class="mb-2 font-medium mt-4">Switch</v-label>
            <v-row>
            ...
            <v-row class="mt-6 ">
                ...
                <v-col cols="12" md="6" class="flex justify-end">
