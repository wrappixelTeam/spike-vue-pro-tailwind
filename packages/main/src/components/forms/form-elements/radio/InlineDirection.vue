...
<template>
    <div class="flex justify-center items-center flex-column flex-sm-row">
        <v-radio-group hide-details v-model="radioGroup3" inline class="flex gap-3 justify-center">
