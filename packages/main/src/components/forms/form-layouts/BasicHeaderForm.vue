...
<template>
    <v-row>
        <v-col cols="12" lg="12">
            ...
            <v-row>
                <v-col cols="12" md="6">
                    <v-label class="mb-2 font-medium">First Name</v-label>
                    <v-text-field variant="outlined" color="primary"></v-text-field>
                    <v-label class="mb-2 font-medium">Select Gender</v-label>
                    <v-select :items="gender" item-title="gender" item-value="abbr" return-object single-line variant="outlined"></v-select>
                </v-col>
                <v-col cols="12" md="6">
                    <v-label class="mb-2 font-medium">Last Name</v-label>
                    <v-text-field variant="outlined" color="primary"></v-text-field>
                    <v-label class="mb-2 font-medium">Date of Birth</v-label>
                    <v-text-field color="primary" variant="outlined" type="date" ></v-text-field>
                </v-col>
            </v-row>
            <v-label class="mb-2 font-medium">Membership</v-label>
            ...
            <v-row>
                <v-col cols="12">
                    <v-label class="mb-2 font-medium">Street</v-label>
                    <v-text-field variant="outlined" color="primary" hide-details></v-text-field>
                </v-col>
                <v-col cols="12" md="6">
                    <v-label class="mb-2 font-medium">City</v-label>
                    <v-text-field variant="outlined" color="primary"></v-text-field>
                    <v-label class="mb-2 font-medium">Post Code</v-label>
                    <v-text-field variant="outlined" color="primary"></v-text-field>
                </v-col>
                <v-col cols="12" md="6">
                    <v-label class="mb-2 font-medium">State</v-label>
                    <v-text-field variant="outlined" color="primary"></v-text-field>
                    <v-label class="mb-2 font-medium">Country</v-label>
                    <v-select
                        :items="country"
                        item-title="country"
                        item-value="abbr"
