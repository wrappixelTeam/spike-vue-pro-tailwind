            ...
            <v-col cols="12" md="8">
                <v-card elevation="10">
                    <v-card-item>
                        ...
                        <div class="d-sm-flex justify-between mt-4 mb-8">
                            <div class="text-sm text-grey100 text-13 pr-5">
                        ...
                        <div class="flex justify-between my-4">
                            <div>
                                <h6 class="text-base mb-1">Authentication App</h6>
                                <h5 class="text-sm text-grey100">Google auth app</h5>
                            </div>
                        ...
                        <div class="flex justify-between my-4">
                            <div>
                                <h6 class="text-base mb-1">Another e-mail</h6>
                                <h5 class="text-sm text-grey100">E-mail to send verification link</h5>
                            </div>
                            <v-btn class="bg-lightprimary text-primary" flat>Setup</v-btn>
                        </div>
                        <v-divider></v-divider>
                        <div class="flex justify-between my-4">
                            <div>
                                <h6 class="text-base mb-1">SMS Recovery</h6>
                                <h5 class="text-sm text-grey100">Your phone number or something</h5>
                            </div>
                            <v-btn class="bg-lightprimary text-primary" flat>Setup</v-btn>
                        </div>
                    </v-card-item>
            ...
            <v-col cols="12" md="4">
                <v-card elevation="10">
                    <v-card-item>
                        ...
                        <h5 class="text-lg mt-4">Devices</h5>
                        <div class="text-sm mt-3 text-grey100 text-10">
                        ...
                        <div class="mt-sm-8 mt-5">
                            <div class="flex items-center my-4">
                                ...
                                <div class="ml-3 pr-3">
                                    <h6 class="text-base mb-1">iPhone 14</h6>
                                    <h5 class="text-sm text-grey100">London UK, Oct 23 at 1:15 AM</h5>
                                </div>
                            ...
                            <div class="flex items-center my-4">
                                ...
                                <div class="ml-3 pr-3">
                                    <h6 class="text-base mb-1">Macbook Air</h6>
                                    <h5 class="text-sm text-grey100">Gujarat India, Oct 24 at 3:15 AM</h5>
                                </div>
                                <v-btn size="30" icon variant="flat" class="lightprimary ml-auto">
                                    <v-avatar size="20">
                                        <DotsVerticalIcon />
