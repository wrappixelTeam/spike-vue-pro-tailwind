                ...
                <v-col cols="12" md="4" sm="6" v-for="(card, i) in filteredCards" :key="i">
                    <v-card elevation="10" class="card-hover">
                        <v-card-item class="text-center">
                            ...
                            <h4 class="text-lg font-semibold mt-3">{{ card.name }}</h4>
                            <span class="text-truncate d-block gap-2 text-xs font-medium">
                                {{ card.role }}
                            </span>
                        </v-card-item>
                        <v-divider />
                        <v-sheet class="bg-lightprimary px-4 py-2 flex items-center justify-center gap-2">
